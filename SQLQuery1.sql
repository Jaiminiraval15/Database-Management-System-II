...
SELECT NAME,ENROLLMENTNO FROM STUDENT WHERE STU_ID>103 AND STU_ID<105
...
UPDATE STUDENT SET DIVISION='BCX-5', SEM=5 WHERE STU_ID=102
15. --Change the Student’s Name to Firoz Sherasiya in which Email is Firoz.Me@Gmail.Com & Contact No is
8885999922.
UPDATE STUDENT SET NAME='FIROZ SHERASIYA' WHERE CONTACTNO=8885999922 AND EMAIL='Firoz.Me@Gmail.Com'
...
SP_RENAME 'STUDENT.EMAIL','STUDENT.EMAILADDRESS'
